...
public class TrackerSettings {
    ...
    public static final CharSequence TRACKER_CLASS = Double.parseDouble(System.getProperty("java.specification.version")) >= 1.8 ? "de/codecentric/performance/agent/allocation/Java8Tracker" : "de/codecentric/performance/agent/allocation/Java6Tracker";
