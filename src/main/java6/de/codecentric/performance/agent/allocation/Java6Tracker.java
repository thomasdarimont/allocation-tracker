...
import static de.codecentric.performance.agent.allocation.TrackerSettings.*;
 ...
 */
public class Java6Tracker {

    private static ConcurrentHashMap<String, AtomicLong> counts = new ConcurrentHashMap<String, AtomicLong>(MAP_SIZE,
            LOAD_FACTOR, CONCURRENCY_LEVEL);

    /**
     * Accessed via Reflection by {@link de.codecentric.performance.agent.allocation.mbean.AgentController}.
     */
    ...
    private static final Tracker TRACKER = new Tracker() {
        ...
        @Override
        public String buildTopList(int amount) {
            return Java6Tracker.buildTopList(amount);
        }
    };
